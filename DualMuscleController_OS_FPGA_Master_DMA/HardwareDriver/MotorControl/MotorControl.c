...
__attribute__((section(".RAM_D2"))) __ALIGNED(32) uint8_t Motor1_CTRLBuffer[Motor_Buffer_Len];
uint8_t Motor1_Return_Data[32];

__attribute__((section(".RAM_D2"))) __ALIGNED(32) uint8_t Motor2_CTRLBuffer[Motor_Buffer_Len];
