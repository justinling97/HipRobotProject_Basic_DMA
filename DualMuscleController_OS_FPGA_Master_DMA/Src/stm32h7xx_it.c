...
/* USER CODE BEGIN EV */
extern void USART5_DMAHandler(void);
/* USER CODE END EV */
...
void UART7_IRQHandler(void)
{
  /* USER CODE BEGIN UART7_IRQn 0 */
	...
	if(__HAL_UART_GET_FLAG(&huart7, UART_FLAG_ORE) != RESET) //Avoid the overrun error of this UART
	{
...
//	HAL_UARTEx_ReceiveToIdle_DMA(&huart8,GPS_RXBuffer,GPS_RXBufferLen);
//	xReturn = osSemaphoreRelease(GPSRetStateHandle);
